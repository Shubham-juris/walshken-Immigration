...
//           <!-- IMPORTANT NOTICE --> <div style=" background: #fff5f5; padding: 18px; border-radius: 12px; margin-bottom: 18px; border-left: 5px solid #e53e3e; "> <p style=" margin-bottom: 12px; color: #c53030; font-size: 15px; font-weight: 600; line-height:1.7; "> Each and every text msg and call is paid. </p> <p style=" color: #2d3748; font-size: 15px; font-weight: 500; line-height:1.7; "> Someone will get back to you in <span style=" color:#e53e3e; font-weight:bold; "> 42 to 72hr </span> </p> </div>
...
const CanadaImmigrationForm = () => {
  ...
  const countriesList = [
    ...
    "Nigeria", "Philippines", "Pakistan", "China", "United Arab Emirates", 
    "Germany", "France", "Brazil", "Mexico", "South Africa", "Other"
  ];
  ...
  const serviceOptions = [
    ...
    "Inadmissibility & TRP",
    "Detention & Removal Appeals",
    "Tech Immigration Programs",
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(formErrors).length > 0) {
      ...
      Swal.fire({
        title: '<span style="color: #1a202c; font-size: 20px;">Missing Required Fields</span>',
        text: "Please complete all highlighted fields marked with an asterisk (*).",
        icon: "warning",
        iconColor: "#e53e3e",
        background: "#ffffff",
        confirmButtonColor: "#e53e3e",
        customClass: {
          popup: "rounded-xl border-2 border-red-500",
        },
      });
      return;
    }
    ...
    setTimeout(() => {
      ...
      Swal.fire({
        title: `<span style="color: #1a202c; font-weight: bold;">Thank You, ${formData.firstName}!</span>`,
        html: `
          <div style="text-align: left; color: #2d3748; font-size: 14px; line-height: 1.6;">
            <p style="margin-bottom: 12px;">Your assessment form has been successfully submitted to the <strong>Walshken Immigration</strong> consulting team.</p>
            <div style="background: #f7fafc; padding: 12px; border-radius: 8px; border-left: 4px solid #e53e3e; margin-bottom: 12px;">
              <p style="margin: 0; color: #4a5568;">Our team aims to review submitted profiles and respond within <strong>1–3 business days</strong>.</p>
            </div>
            <p style="font-size: 12px; color: #718096; margin: 0;">Please keep an eye on your email inbox for preliminary next steps.</p>
          </div>
        `,
        icon: "success",
        iconColor: "#38a169",
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="flex items-center justify-center gap-2 mb-6">
            <img src={logo} alt="Walshken Immigration" className="w-9 h-9 object-contain" />
          ...
          <p className="text-gray-400 text-xs sm:text-sm max-w-xl mx-auto leading-relaxed">
            Please fill out the form below so our team can evaluate your profile and provide the best immigration options for you.
          </p>
        </div>

        {/* Main Form Container */}
        <div className="bg-gray-950 border border-gray-800 rounded-2xl p-6 sm:p-10 shadow-2xl">
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <input
                    ...
                    } text-sm text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition`}
                  />
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                className={`w-full p-3 rounded-lg bg-gray-900 border ${
                  errors.dateOfBirth ? "border-red-500" : "border-gray-800"
                } text-sm text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition`}
              />
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className={`w-full p-3 rounded-lg bg-gray-900 border ${
                  errors.countryOfResidence ? "border-red-500" : "border-gray-800"
                } text-sm text-white focus:outline-none focus:border-red-500 transition`}
              >
              ...
              {errors.countryOfResidence && (
                <p className="text-red-500 text-xs mt-1">{errors.countryOfResidence}</p>
              )}
            </div>

            {/* What type of immigration service are you interested in? */}
            <div>
              <label className="block text-xs font-bold text-white mb-2 uppercase tracking-wider">
                What type of immigration service are you interested in? <span className="text-red-500">*</span>
              </label>
              <select
                ...
                onChange={handleChange}
                className={`w-full p-3 rounded-lg bg-gray-900 border ${
                  errors.serviceInterested ? "border-red-500" : "border-gray-800"
                } text-sm text-white focus:outline-none focus:border-red-500 transition`}
              >
              ...
              {errors.serviceInterested && (
                <p className="text-red-500 text-xs mt-1">{errors.serviceInterested}</p>
              )}
            </div>
            ...
            <div>
              ...
              <select
                ...
                onChange={handleChange}
                className="w-full p-3 rounded-lg bg-gray-900 border border-gray-800 text-sm text-white focus:outline-none focus:border-red-500 transition"
              >
                <option value="">Select an option</option>
                {referralOptions.map((ref, idx) => (
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-3 rounded-lg bg-gray-900 border border-gray-800 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-red-500 transition resize-none"
              ></textarea>
            </div>
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-4 bg-red-600 hover:bg-red-700 text-white font-extrabold text-sm uppercase tracking-widest rounded-lg shadow-lg shadow-red-900/30 transition transform hover:-translate-y-0.5 disabled:opacity-50"
              >
        ...
        <div className="text-center text-gray-500 text-xs mt-8 space-y-1">
          <p>© {new Date().getFullYear()} Walshken Immigration. All rights reserved.</p>
          <p>Submission of this form does not guarantee visa or residency outcomes.</p>
        </div>
      </div>
    </div>
  );
