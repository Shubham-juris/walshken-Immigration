  ...
  const clientJourneys = [
    {
      ...
      category: "Work Visa",
      readTime: "2 min read",
      title: "My Journey with Walshken Immigration",
      excerpt:
        "Arjun shares how clear explanations, organized preparation and ongoing support helped him move confidently through his work visa application.",
      image: imgArjun,
      fullStory:
        "When I first considered applying for an international work visa, the amount of information available online was overwhelming. Navigating employer requirements, labor assessments, and procedural timelines required clear guidance. The consultants at Walshken Immigration provided a structured, step-by-step roadmap. They reviewed every employment document, verified compliance criteria, and kept me informed throughout the process. Their continuous support gave me confidence from initial document gathering to final visa issuance.",
    },
    {
      id: 2,
      name: "Emily Richardson",
      category: "Work Permit",
      readTime: "2 min read",
      title: "From an Employment Opportunity to Working Abroad",
      excerpt:
        "Emily describes how professional guidance made the documentation and work permit requirements easier to understand and manage.",
      image: imgEmily,
      fullStory:
        "Securing an eligible job offer was an exciting milestone, but organizing the required work permit documentation was complex. Walshken Immigration worked closely with both myself and my prospective employer. They explained the specific regulatory criteria in plain language and ensured that our submission package was complete, organized, and compliant with current immigration rules. Having dedicated professionals manage the administrative details made the entire relocation process smooth and manageable.",
    },
    {
      id: 3,
      name: "David Chen",
      category: "Visitor Visa",
      readTime: "2 min read",
      title: "A Special Trip Made Possible",
      excerpt:
        "David explains how patient guidance and carefully organized supporting documents helped him approach his visitor visa application.",
      image: imgDavid,
      fullStory:
        "I was planning an extended trip to visit my family and attend key milestone events. Temporary resident applications require a strong demonstration of ties to your home country, financial readiness, and clear travel itineraries. Walshken Immigration conducted a thorough review of my personal documentation and helped me arrange a complete application that addressed all consular evaluation criteria. Their patient approach ensured my file was prepared accurately on the first submission.",
    },
    {
      id: 4,
      name: "Maria Santos",
      category: "Permanent Residence",
      readTime: "2 min read",
      title: "My Journey Toward Permanent Residence",
      excerpt:
        "Maria reflects on understanding her options, preparing her documentation and feeling supported throughout her permanent residence journey.",
      image: imgMaria,
      fullStory:
        "Transitioning to permanent residence was one of the most important decisions of my life. Understanding the various economic classes and regional streams required personalized attention. Walshken Immigration evaluated my work experience, credential evaluations, and language points to determine the strongest pathway for my profile. Their team handled the complex paperwork with meticulous care, guiding me through each stage until my permanent residency was approved.",
    },
  ];
  ...
  const immigrationResources = [
    {
      ...
      category: "Skilled Immigration",
      readTime: "5 min read",
      title: "How Data Scientists Can Explore Global Immigration Pathways",
      excerpt:
        "Explore pathways that may be relevant to data professionals and the experience, language and documentation factors commonly considered.",
      image: imgResource1,
      link: "/tech-immigration",
    },
    {
      ...
      category: "Employer Immigration",
      readTime: "5 min read",
      title: "A Step-by-Step Guide to the LMIA Process",
      excerpt:
        "Understand the employer-side process, required preparation and key documentation involved in an LMIA application.",
      image: imgResource2,
      link: "/work-visa",
  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      >
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-extrabold text-white mb-6 leading-tight">
            <span className="text-red-500">Global Immigration</span> <br />
            Insights
          </h1>
          <p className="text-gray-300 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
            Practical immigration guidance and client experiences to help individuals, 
            families and employers make informed decisions.
          </p>
        </div>
      </section>
