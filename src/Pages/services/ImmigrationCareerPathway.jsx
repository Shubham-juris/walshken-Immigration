    ...
    <div className="bg-gradient-to-br from-black via-gray-900 to-red-950 text-white min-h-screen font-sans">
      ...
      <section className="py-20 md:py-28 px-6 text-center relative">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-300 max-w-3xl mx-auto mb-8 font-light leading-relaxed">
            Understand how professional practitioners operate, discover the path to becoming a licensed consultant, and gain practical shadowing experience with our team.
          </p>
      ...
      {/* ────────────────────────────────────────────────────────
          INTRODUCTION SECTION (ASTERISKS REMOVED)
          ──────────────────────────────────────────────────────── */}
      <section className="max-w-5xl mx-auto py-12 px-6 md:px-12">
        <motion.div
          className="text-center"
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-sm md:text-base max-w-4xl mx-auto mb-6">
            For individuals who are new to Canada or exploring a career in immigration, entering the system can seem challenging. While educational courses teach the regulatory frameworks, understanding the day-to-day realities of consulting is where genuine professional readiness is built.
          </p>
          {/* FIXED: Removed raw ** asterisks */}
          <p className="text-gray-300 leading-relaxed text-sm md:text-base max-w-4xl mx-auto">
            At <span className="text-white font-bold">Walshken Immigration</span>, we believe in opening our doors to aspiring practitioners. We offer structured opportunities to observe how professional consultants work, manage clients, and process files in a compliant, real-world setting.
          </p>
        </motion.div>
      </section>

      {/* ────────────────────────────────────────────────────────
          SECTION 1: HOW TO BECOME AN RCIC (FIXED GRID CLIPPING)
          ──────────────────────────────────────────────────────── */}
      <section className="max-w-7xl mx-auto py-16 px-6 md:px-12 lg:px-20 border-t border-red-950/40">
        <div className="text-center mb-14">
          ...
          <p className="text-xs md:text-sm text-gray-400 max-w-2xl mx-auto mt-3">
            If you are a newcomer to Canada or looking to change careers, these are the primary steps you must take to enter the field of immigration consulting:
          </p>
        </div>

        {/* Responsive, non-clipping 4-card grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <motion.div
              key={idx}
              className="bg-gray-950/70 p-6 rounded-xl border border-gray-800 shadow-xl flex flex-col justify-between hover:border-red-500/40 transition-all"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={fadeUp}
            ...
            >
              <div>
                <div className="text-xs font-bold text-red-500 mb-3 uppercase tracking-widest">{milestone.step}</div>
      ...
      {/* ────────────────────────────────────────────────────────
          SECTION 2: PRACTICAL SHADOWING & VOLUNTEERING (EXPANDED SPACING)
          ──────────────────────────────────────────────────────── */}
      <section className="bg-black/50 py-20 px-6 md:px-12 lg:px-20 border-t border-b border-red-950/40">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-12 gap-10 items-stretch">
            ...
            >
              <span className="text-red-500 font-semibold text-xs uppercase tracking-wider block mb-2">Supervised Exposure</span>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-5 bg-gradient-to-r from-[rgb(254,230,186)] to-[rgb(240,200,140)] bg-clip-text text-transparent">
                Observe & Learn: Our Volunteer Shadowing Program
              </h2>
            ...
            {/* Right Column: Visual Side Card (Comfortable Padding) */}
            <motion.div
              className="lg:col-span-5 bg-gradient-to-br from-red-950/30 to-black p-8 rounded-2xl border border-red-800/80 shadow-2xl flex flex-col justify-center"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={fadeUp}
            ...
            >
              <span className="text-red-500 font-semibold text-xs uppercase tracking-wider block mb-2">Practice Ready</span>
              <h4 className="text-lg font-bold text-white mb-3">Gaining Practical Confidence</h4>
      ...
      {/* ────────────────────────────────────────────────────────
          SECTION 3: APPLY TO SHADOW (PROPERLY SPACED, NO CLIPPING)
          ──────────────────────────────────────────────────────── */}
      <section className="py-20 md:py-28 text-center bg-gradient-to-t from-red-950/20 to-transparent">
        <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          ...
          className="max-w-4xl mx-auto px-6"
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold mb-6 bg-gradient-to-r from-[rgb(254,230,186)] to-[rgb(240,200,140)] bg-clip-text text-transparent">
            Apply to Shadow Our Team
          </h2>
          <p className="text-gray-300 max-w-2xl mx-auto mb-4 text-sm sm:text-base leading-relaxed">
            Are you currently enrolled in an immigration diploma, newly licensed, or simply looking to understand the day-to-day operations of an active consulting practice? 
          </p>
          ...
          <button
            onClick={() => navigate("/contact")}
            className="px-8 py-3.5 bg-red-600 hover:bg-red-700 text-white font-bold text-sm uppercase tracking-wider rounded-lg shadow-lg shadow-red-900/30 transition transform hover:-translate-y-0.5"
          >
            Submit a Volunteer Inquiry
          </button>
        </motion.div>
