  ...
  const comprehensiveServices = [
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVo4DTHuJbcI6f68KO67vur1LUO1kZdXIZ7Z0Dl_TGzA&s=10",
    },
    {
      title: "Intra-Company Transfers (ICT)",
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSsoRfvOakfbHjuIG4gKPJmjvOnjcOtDWqH5wj-Zz0AZw&s=10",
    },
    {
      title: "Tech Sector Fast-Track Options",
      desc: "Advising technology firms and skilled professionals on fast-tracked pathways structured for highly competitive technical markets.",
      icon: <FaLaptopCode className="text-red-500 text-xl" />,
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzziC0Su1GTsBsOHqatMWtCxEaOk--DGlSa7ACwmrJRQ&s=10",
    },
    {
      title: "Skill Assessment & Credential Services",
      desc: "We assist with educational credential assessment (WES, IQAS, etc.) required to satisfy regulatory equivalency guidelines.",
      icon: <FaClipboardList className="text-red-500 text-xl" />,
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2cj40inHu3eweDzVRKLabiKUxgfcLH9_4k6idjhBcKA&s=10",
    },
    {
      title: "Language Proficiency Support",
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSC52OEdzgIegYObIIrdVGey-s6B5S3NklYW_PJZ9CcDA&s=10",
    },
    {
      title: "Candidate Profile Audits",
      desc: "Comprehensive assessment of your skills, background, and certifications to position you optimally for visas or employer sponsorships.",
      icon: <FaSearch className="text-red-500 text-xl" />,
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR3lIHSVJbuBc0wr2ZJ09xXWWsBkbH2nl3vC4kMt7S3ag&s=10",
    },
    {
      title: "Skill Gaps & Training Guidance",
      desc: "Specialized advisory resources to target skill gaps and satisfy compliance parameters for specific international markets.",
      icon: <FaBookReader className="text-red-500 text-xl" />,
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8ALdPX8YL_3PX4y-O8yHsyoEK99iURj3zX_LxBUKX1w&s=10",
    },
    {
      title: "Interview Preparation Coaching",
      desc: "Practice sessions and administrative preparation to support you during complex assessment interviews.",
      icon: <FaUserTie className="text-red-500 text-xl" />,
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-JJJvyPAEQEz2fi3hmmC1vAPsTnfo19Q63ZPkHV1LEg&s=10",
    },
    {
      title: "Recruitment Coordination Support",
      desc: "Collaboration with international recruitment circles to bridge individual talent directly with active vacancies.",
      icon: <FaHandshake className="text-red-500 text-xl" />,
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJoQW5zdmYtj45GpYS5dbYWeu_HBhjSCRXPVqUOk7itw&s=10",
    },
  ];
  ...
  const workVisaBenefits = [
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcROL41GAIzKX3pF3Mri5XWAnI5BVpQrnkffV_8C-gJFjQ&s=10",
      icon: <FaGlobeAmericas className="text-red-500" />,
    },
    {
      title: "Higher Income",
      desc: "Earn competitive salaries abroad with better compensation and perks.",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvyGk_O7AuMSZyF7KfNBxVOY--HQYWCnUOmuECYhFssg&s=10",
    ...
    },
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRwQSDXYzktUsyzbRifG_AClT5oX2-i_VZJ2D5_sgrX7A&s=10",
    ...
    },
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRYWFnz6ODScY59tJM2-ZZ0BZOarYmVbxyvzunXF8kxyg&s=10",
    ...
    },
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT8L19IkUPye6b4FJTtC4rAxIgfwtnSvWSTA0DwP0FAAw&s=10",
    ...
    },
    {
      ...
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUAkHhPWH8bd2NEFK-R5Uvrw3QI4X4zzARHoVYBhv1Uw&s=10",
