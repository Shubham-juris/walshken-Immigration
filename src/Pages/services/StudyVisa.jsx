...
const StudyVisa = () => {
  ...
  // 1. Destinations with guaranteed SVG/PNG Flag Icons (Renders graphics on all OS)
  const studyDestinations = [
  ...
  // 2. Benefits Data (Preserving your exact image URLs)
  const studyBenefits = [
    {
      title: "Global Education",
      desc: "Access world-class universities and advanced learning systems.",
  ...
  // 4. Why Choose Us (Preserving your exact image URLs, with consulting image for card 3)
  const trustCards = [
    {
      title: "Expert Consultants",
      desc: "Our team provides thorough academic mapping, profile strengthening, and visa compliance guidance.",
    ...
    },
    {
      title: "Comprehensive Care",
      desc: "From your initial assessment up to permit issuance, we support you with clear communication.",
      // Replaced medical-looking image with professional student advising photo
  ...
  return (
    <div className="bg-gradient-to-br from-black via-gray-900 to-red-950 text-white min-h-screen font-sans">
      ...
      {/* ────────────────────────────────────────────────────────
          5. TOP STUDY DESTINATIONS (GRAPHIC FLAG ICONS)
          ──────────────────────────────────────────────────────── */}
      <section className="py-20 px-6 max-w-7xl mx-auto border-t border-red-950/40">
        <motion.div
        ...
        {/* Responsive Grid with Graphic SVG/PNG Flag Icons */}
          ...
          {studyDestinations.map((item, index) => (
            ...
            >
              ...
              <img
                ...
                loading="lazy"
              />
              <h3 className="text-xs font-semibold text-gray-300 hover:text-white truncate">
                {item.country}
              </h3>
            </motion.div>
          ))}
      ...
      {/* ────────────────────────────────────────────────────────
          7. WHY CHOOSE WALSHKEN IMMIGRATION?
          ──────────────────────────────────────────────────────── */}
      <section className="py-20 px-6 max-w-7xl mx-auto border-t border-red-950/40">
        <motion.div
          className="max-w-6xl mx-auto text-center mb-16"
