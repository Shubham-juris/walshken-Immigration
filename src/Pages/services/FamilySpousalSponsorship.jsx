...
const FamilySpousalSponsorship = () => {
  ...
  // 1. Country-wise Sponsorship Programs (with brightened background images)
  const countrySponsorshipPrograms = [
    {
      country: "Canada",
      programs: [
  ...
  return (
    <div className="bg-gradient-to-br from-black via-gray-900 to-red-950 text-white min-h-screen font-sans">
      ...
      {/* ────────────────────────────────────────────────────────
          4. COUNTRY-WISE PROGRAMS (BRIGHTENED BACKGROUNDS + RECOGNIZABLE LANDMARKS)
          ──────────────────────────────────────────────────────── */}
      <section className="py-20 px-6 max-w-7xl mx-auto border-t border-red-950/40">
        <div className="max-w-6xl mx-auto text-center mb-16">
          <p className="text-red-500 font-semibold uppercase tracking-widest text-xs mb-2">Global Programs</p>
          ...
          {countrySponsorshipPrograms.map((country, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="mb-4">
                  <h4 className="text-white font-bold text-xs uppercase tracking-wider mb-2.5 drop-shadow">Available Programs:</h4>
              ...
              <div className="relative z-10 mt-5 pt-4 border-t border-red-950/60 space-y-2.5">
                <div>
                  <h4 className="text-white font-bold text-xs drop-shadow">Estimated Processing:</h4>
                  <p className="text-red-300 text-xs font-bold drop-shadow">{country.processingTime}</p>
                </div>
                
                <div>
                  <h4 className="text-white font-bold text-xs drop-shadow">Key Requirements:</h4>
                  <p className="text-gray-300 text-xs leading-relaxed font-medium drop-shadow-sm">{country.requirements}</p>
                </div>
              </div>
            </motion.div>
          ))}
        ...
        >
          ...
          <div className="grid gap-6 grid-cols-2 md:grid-cols-4 max-w-6xl mx-auto">
            {[
              ...
              <motion.div
                key={index}
                className="bg-gray-950 p-6 rounded-2xl shadow-lg border border-gray-800 hover:border-red-500/50 hover:bg-gray-900 transition-all cursor-pointer text-center"
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
                custom={index * 0.2}
