...
const Contact = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      {/* ────────────────────────────────────────────────────────
          IMMIGRATION FORM CARD & FAQ SECTION (MOCKUP ACCURATE)
          ──────────────────────────────────────────────────────── */}
      <section className="py-20 px-6 max-w-7xl mx-auto border-t border-gray-900">
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          {/* Left Side: APPROVED IMMIGRATION ASSESSMENT CARD */}
          <div className="lg:col-span-5 bg-gray-950 p-8 md:p-10 rounded-2xl border border-gray-800 text-center flex flex-col items-center justify-between min-h-[420px] shadow-2xl">
            <div>
              <span className="text-red-500 font-bold uppercase tracking-widest text-xs block mb-6">
                Immigration Form
              </span>
              <div className="w-20 h-20 rounded-full border-2 border-red-500 p-2 mb-6 flex items-center justify-center bg-black shadow-lg shadow-red-900/20 mx-auto">
                <img src={logo} alt="Walshken Immigration" className="w-12 h-12 object-contain" />
              </div>
              ...
              <p className="text-xs text-gray-400 max-w-xs mx-auto leading-relaxed">
                Provide your information so our team can better understand your immigration needs.
              </p>
            </div>

            <Link
              to="/form"
              className="mt-8 w-full py-3.5 bg-red-600 hover:bg-red-700 text-white font-bold text-xs uppercase tracking-widest rounded-lg shadow-lg transition transform hover:-translate-y-0.5"
            >
