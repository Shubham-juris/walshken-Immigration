...
const Header = () => {
  ...
  return (
    <div className="bg-black min-h-screen text-white">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 py-20 md:py-28 flex flex-col md:flex-row items-center">
          ...
          >
            ...
            >
              <Link
                to="/services"
                className="px-6 py-3.5 bg-red-600 text-white font-semibold rounded-full shadow-lg hover:bg-red-700 transition-transform transform hover:scale-105"
              >
                Explore Services
              </Link>
            </motion.div>
      ...
      <section className="relative py-20 px-6 bg-gradient-to-r from-black via-gray-900 to-red-900 overflow-hidden">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-red-500 mb-6 leading-tight">
      ...
      {/* ────────────────────────────────────────────────────────
          SECTION 3.4: CONSULTATION GUIDANCE SECTION ("HOW WE WORK")
          ──────────────────────────────────────────────────────── */}
      <section className="py-20 bg-gray-950 text-white border-t border-red-950/20">
        {/* Centered Main Section Heading */}
        <div className="max-w-7xl mx-auto px-6 lg:px-20 text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-extrabold text-red-500">
            How We Work
          </h2>
          <div className="h-[2px] w-24 bg-red-600 mx-auto mt-4"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-20 grid md:grid-cols-2 gap-12">
          ...
          >
            ...
            {/* Mockup-Style Numbered List (Circles with numbers inside, no trailing dots) */}
            <ul className="space-y-4 text-sm text-gray-300">
              <li className="flex items-start">
                <div className="w-6 h-6 rounded-full bg-red-600 text-white font-bold text-xs flex items-center justify-center mr-3.5 mt-0.5 flex-shrink-0">
                  1
                </div>
                <span>Understand your immigration goal and immediate concerns.</span>
              </li>
          ...
          >
            <div>
              ...
              {/* Mockup-Style Bullet List (Red check circles instead of dots) */}
              <ul className="space-y-3.5 text-sm text-gray-300 mb-6">
                <li className="flex items-start">
